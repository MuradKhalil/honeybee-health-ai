...
# bee_health_monitoring documentation build
...
from bee_health_monitoring import __version__ as release

# -- Project information -----------------------------------------------------

project = "bee_health_monitoring"
author = "QuantumBlack"
...
htmlhelp_basename = "bee_health_monitoringdoc"
...
latex_documents = [
    (
        master_doc,
        "bee_health_monitoring.tex",
        "bee_health_monitoring Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "bee_health_monitoring",
        "Project bee_health_monitoring codebase.",
        "Data-Science",
    )
]
